    ...
    for epoch in range(2000):
        ...
        with torch.no_grad():
            ...
            if val_num > 0:
                ...
                print("val: mse: {:.4f}  mae: {:.4f}".format(val_avg_mse, val_avg_mae))
            ...
            if test_num > 0:
                ...
                print("Test: mse: {:.4f}  mae: {:.4f}".format(test_avg_mse, test_avg_mae))
        ...
        if early_stop_epoch == opt.early_stop_epoch:
            ...
            if test_num > 0:
                f.write("test: mse: {:.3f}\tmae: {:.3f}\tmedian: {:.3f}\n".format(
                    test_avg_mse, test_avg_mae, test_median))
            if val_num > 0:
                f.write("val: mse: {:.3f}\tmae: {:.3f}\tmedian: {:.3f}\n".format(
                    val_avg_mse, val_avg_mae, val_median))
            f.close()
            break
